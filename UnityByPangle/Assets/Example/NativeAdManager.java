...
public class NativeAdManager {
    ...
    //相关调用注意放在主线程
    public void showNativeFeedAd(final Context context, final TTNativeAd nativeAd) {
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                mFeedView = new FeedView(context);
                ...
                //绑定原生广告的数据
                setFeedAdData(mFeedView, nativeAd);
            }
        });
    }
    ...
    private void removeFeedView() {
        removeAdView((Activity) mContext, mFeedView);
    }
    ...
    private void setFeedAdData(FeedView nativeView, TTNativeAd nativeAd) {
        ...
        if (nativeAd != null && (nativeAd.getImageMode() == TTAdConstant.IMAGE_MODE_VIDEO
        || nativeAd.getImageMode() == TTAdConstant.IMAGE_MODE_VIDEO_VERTICAL || nativeAd.getImageMode() == TTAdConstant.IMAGE_MODE_VIDEO_SQUARE)) {
            View video = nativeAd.getAdView();
                    if (video != null) {
                        if (video.getParent() == null) {
                            nativeView.addView(video);
                        }
                    }
        } else if (nativeAd.getImageList() != null && !nativeAd.getImageList().isEmpty()) {
        ...
        switch (nativeAd.getInteractionType()) {
            case TTAdConstant.INTERACTION_TYPE_DOWNLOAD:
               ...
               mCreativeButton.setText("Download");
                break;
            case TTAdConstant.INTERACTION_TYPE_DIAL:
                mCreativeButton.setVisibility(View.VISIBLE);
                mCreativeButton.setText("Call now");
                break;
        ...
        nativeAd.registerViewForInteraction((ViewGroup) nativeView, clickViewList, creativeViewList, dislike, new TTNativeAd.AdInteractionListener() {
            ...
            public void onAdClicked(View view, TTNativeAd ad) {
                if (ad != null) {
                    Toast.makeText(mContext, "AD" + ad.getTitle() + "Clicked", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onAdCreativeClick(View view, TTNativeAd ad) {
                if (ad != null) {
                    Toast.makeText(mContext, "AD" + ad.getTitle() + "the creative button is clicked", Toast.LENGTH_SHORT).show();
                }
            }
            ...
            public void onAdShow(TTNativeAd ad) {
                if (ad != null) {
                    Toast.makeText(mContext, "AD" + ad.getTitle() + "Show", Toast.LENGTH_SHORT).show();
                }
            }
        });
